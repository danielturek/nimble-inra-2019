...
##save('n', 'r', file = '~/github/nimble/nimble-inra-2019/docs/data/litters_data.Rdata')
...
##save('samplesList', 'samplesCodaList', 'ESS', file = '~/github/nimble/nimble-inra-2019/docs/data/litters_samples.Rdata')
...
load('~/github/nimble/nimble-inra-2019/docs/data/dipperData.RData')
sightings <- y
...
save('sightings', 'first', 'gender', file = '~/github/nimble/nimble-inra-2019/docs/data/dipper_data.Rdata')

## saving dipper samples
library(nimble)
load('~/github/nimble/nimble-inra-2019/docs/data/dipper_data.Rdata')
...
save('samples', 'samples2', 'samples3', file = '~/github/nimble/nimble-inra-2019/docs/data/dipper_samples.RData')
...
##save('vege', 'wind', 'obs', file = '~/github/nimble/nimble-inra-2019/docs/data/occupancy_data.Rdata')
...
##save('samples', 'time', 'samples2', 'time2', file = '~/github/nimble/nimble-inra-2019/docs/data/occupancy_samples.Rdata')
...
load('~/github/nimble/nimble-inra-2019/docs/data/orchidData.RData')
first <- f
save('y', 'first', file = '~/github/nimble/nimble-inra-2019/docs/data/orchid_data.Rdata')
