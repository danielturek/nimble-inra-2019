...
conf$resetMonitors()
conf$printMonitors()
conf$addMonitors(c('gender', 'phi', 'p'))
...
samplesList <- runMCMC(Cmcmc, niter = 20000,
                       nburnin = 10000)
...
samplesPlot(samples[100:200, 'gender[189]', drop=FALSE])
