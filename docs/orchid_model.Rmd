...
load('~/github/nimble/nimble-inra-2019/docs/data/orchid_data.Rdata')
```
...
Data for the orchid model (from Kery and Schuab) <a href="https://danielturek.github.io/nimble-inra-2019/data/orchid_data.Rdata" target="_blank" style="color: blue">can be downloaded here</a>.
...
save('out', 'samples', file = '~/github/nimble/nimble-inra-2019/docs/data/orchid_samples.Rdata')
```

```{r echo = FALSE}
load('~/github/nimble/nimble-inra-2019/docs/data/orchid_samples.Rdata')
```
