...
In case you need it again, you can <a href="https://danielturek.github.io/nimble-inra-2019/data/dipper_data.Rdata" style="color: blue">download the dipper data here</a>.
...
dipperConstsCJS <- list(N = N, T = T, first = first)

dipperDataCJS <- list(y = sightings)

dipperInitsCJS <- list(phi = 0.5, p = 0.5)

Rmodel <- nimbleModel(dipperCodeCJS, dipperConstsCJS, dipperDataCJS, dipperInitsCJS)
...
set.seed(0)
samplesCJS <- runMCMC(Cmcmc, niter = 20000, nburnin = 10000)
```
